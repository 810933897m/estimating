            ...
            <el-form ref="form" label-width="120px" :model="form" style="width:100%;">
              <div style="width:100%;position:relative;height:50px;">
                <p style="margin-left:50px;">原始单价{{old_price}},修改单价{{new_price}}</p>
                  <el-form-item label="询值单价" class="form-input" prop="title" style="width:250px;float:left;">
                    <el-input  placeholder="请输入净值单价" v-model="ask_univalence"></el-input>
                </el-form-item>
