<template>
  <div class="app-container">
    ...
    <!-- <el-form ref="form" >
      ...
      <el-form ref="form" >
        <el-form-item>
            <el-radio v-model="activeName" label="zero" @change="handleClick()">申请退款</el-radio>
            <el-radio v-model="activeName" label="first" @change="handleClick()">待审核</el-radio>
            <el-radio v-model="activeName" label="two" @change="handleClick()">已通过</el-radio>
            <el-radio v-model="activeName" label="three" @change="handleClick()">已拒绝</el-radio>
            <el-radio v-model="activeName" label="four" @change="handleClick()">已取消 </el-radio>
            ...
            <el-button type="primary" style="" plain @click="searchBtn">查询</el-button>
            <el-button type="primary" style="" v-if="activeName == 'zero'" plain @click="BillingBtn()">添加退款</el-button>
        </el-form-item>
    </el-form>
    ...
    <!--*************添加收款模态框*************-->
        ...
        <!-- :before-close="handleClose" -->
            <el-form label-width="90px" style="float:left;">
                ...
                <el-form-item label="退款方式" class="select" style="float:left;">
              ...
              <el-form-item label="退款审核人" class="select" style="float:left;">
                <el-select v-model="refund_audit_id" filterable placeholder="请选择" style="">
                    <el-option
                    v-for="item in refund_audit_id1"
                    :key="item.value"
                    :label="item.label"
                    :value="item.value">
                    </el-option>
              ...
              <el-form-item label="退款总金额" style="width:250px;float:left;" >
                  <el-input disabled placeholder="请输入退款金额" v-model="add.charge_amount_total"></el-input>
                </el-form-item>

              <!-- <el-form-item label="收款日期" style="width:250px;float:left;">
                  <el-input placeholder="请输入收款日期" v-model="add.transfer_date"></el-input>
                </el-form-item> -->
                <el-form-item label="退款日期" style="width:300px;float:left;">
                  <el-date-picker
              ...
              <el-form-item label="付款方" style="width:250px;float:left;">
                ...
                <el-form-item label="退款备注" style="width:250px;float:left;">
                  <el-input placeholder="请输入退款备注" v-model="add.charge_remark"></el-input>
                </el-form-item>
      ...
      handleSizeChange: function (size) {
        ...
        confirmRevisionAdd(){
          ...
          request.post("/admin/FinancialRefund/create",{
                ...
                total_refund_amount : this.add.charge_amount_total,
