  ...
  <div class="app-container">
    ...
    <el-table 
      ...
      width="200px" align="center">
        <template slot-scope="scope">
          <el-button size="small" type="primary" v-if="activeName == 'first'" @click="refuse(scope.row)" >打印报告</el-button>
          </template>
      </el-table-column>
    ...
    <!-- *************分页************* -->
          ...
          <!-- 分配任务弹出框 -->
          <el-dialog style="" :append-to-body='true' title="打印报告" :visible.sync="dialogFormVisible">
            ...
            <el-form ref="form" label-width="120px" :model="form" style="width:100%;">
              ...
              <el-button size="small" type="primary" style="margin-left:20px;margin-top:5px;" @click="outworkidBtn1()">打印报告</el-button>
              </div>
...
export default {
    ...
    methods: {
      ...
      outworkidBtn1(){//打印报告
          request.post("/admin/projectPrint/done",{
          id : this.Id,
