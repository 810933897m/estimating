<template>
    <div class="app-container">
        <div style="margin-bottom:20px;width:100%;background:rgb(48,65,85);color:white;height:30px;"><span style="float:left;margin-left:10px;margin-top:5px;font-size:15px;">用户详情</span></div>
        <el-form ref="form" :model="form" label-width="120px" style="width:90%;padding-right:50px;">
            ...
            <el-form-item label="状态" class="form-input" prop="title" style="width:500px;">
                <el-input  disabled v-model="form.status"></el-input>
            </el-form-item>
