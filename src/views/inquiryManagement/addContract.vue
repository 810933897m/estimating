    ...
    <div class="app-container">
        ...
        <el-form ref="form" :model="form" label-width="120px" style="width:90%;padding-right:50px;">
            ...
            <el-form-item label="合同编号" class="form-input"  prop="title" style="width:500px;">
                <el-input  placeholder="请输入合同编号"  v-model="form.contract_no"></el-input>
            </el-form-item>

            <el-form-item label="甲方" class="form-input" prop="title" style="width:500px;">
                <el-input  placeholder="请输入甲方" v-model="form.first_party"></el-input>
            </el-form-item>

            <el-form-item label="乙方" class="form-input" prop="title" style="width:500px;">
                <el-input  placeholder="请输入乙方" v-model="form.second_party"></el-input>
            </el-form-item>
        ...
        addCommodity(){//点击提交按钮
            console.log(this.form)
                ...
                request.post("/admin/contractManagement/create", {//发送数据到后台
                    ...
                    first_party : this.form.first_party,
                    construct_area : this.form.construct_area,
                    second_party : this.form.second_party,
